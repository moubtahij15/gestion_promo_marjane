            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="#" class="text-xl font-bold flex items-center lg:ml-2.5">
                        <img src="https://appsgeyser.io/geticon.php?widget=Marjane%20%D9%85%D8%B1%D8%AC%D8%A7%D9%86_7131104&width=512" class="h-12 mr-2" alt="Windster Logo">
                        ...
                        <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                                    <div class="flex-shrink-0">
                                        <a href="#" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg p-2">Ajouter Promotion</a>
                                    </div>
                                </div>
                            </div>
                            <div class="block w-full overflow-x-auto">
                                <table class="items-center w-full bg-transparent border-collapse">
                                    <thead>
                                    <tr>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap">Date Debut</th>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">Date Fin</th>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">Pourcentage</th>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">Fidélité</th>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">Type</th>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">Rayon/sous Categorie</th>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">Status</th>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">Edit</th>
                                        <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">Delete</th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr class="text-gray-500">
                                        ...
                                        <td class="border-t-0 px-4 align-middle text-center text-xs font-medium text-gray-900 whitespace-nowrap p-4">${promo.getPoucentage()}</td>
                                        ...
                                        <td class="border-t-0 px-4 align-middle text-xs text-center font-medium text-gray-900 whitespace-nowrap p-4">${promo.getCategorieByIdCategorie().getNom()}</td>
                                        ...
                                        <td class="border-t-0 px-4 align-middle text-xs text-center font-medium text-gray-900 whitespace-nowrap p-4">Edit</td>
                                        <td class="border-t-0 px-4 align-middle text-xs  text-center font-medium text-gray-900 whitespace-nowrap p-4">Delet</td>
                                        </tr>
                                    </c:forEach>
