        ...
        <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
            <main>
                <div class="pt-6 px-4">
                    ...
                    >
                        <main id="content" role="main" x-show="open" class="w-full max-w-md mx-auto p-6">
                            <div class="mt-7 bg-white  rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700">
                                <div class="p-4 sm:p-7">
                                    <div class="text-center">
                                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Valider la
                                            Promotion</h1>
                                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                            la promotion que vous validez est
                                            <span x-text="idPromo" class="text-blue-600 decoration-2 hover:underline font-medium"
                                                  >
                                            </span>
                                        </p>
                                    </div>
                                    ...
                                    <div class="mt-5">
                                        <form method="post" action="/ResponsableRayon/ValiderPromotion">
                                            <div class="grid gap-y-4">
                                                <div>
                                                    <label for="commentaire"
                                                           class="block text-sm font-bold ml-1 mb-2 dark:text-white">Commentaire</label>
                                                    <div class="relative">
                                                        <textarea id="commentaire" name="commentaire"
                                                                  class="py-3 px-4 block w-full border-2 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 shadow-sm"
                                                                  required aria-describedby="email-error"></textarea>
                                                    </div>
                                                </div>
                                                <div class="flex items-center justify-start w-full">
                                                    <button x-model="idPromo" name="idPromo" type="submit" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm">Valider</button>
                                                    <button type="button" class="focus:outline-none focus:ring-2 focus:ring-offset-2  focus:ring-gray-400 ml-3 bg-gray-100 transition duration-150 text-gray-600 ease-in-out hover:border-gray-400 hover:bg-gray-300 border rounded px-8 py-2 text-sm" x-on:click="open=!open" ">Annuler</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-shrink-0">
                                <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">Promotion</span>
                        ...
                        <%--                            voir promo--%>
                        <div x-show="open==false" class="block w-full overflow-x-auto">
                                ...
                                <c:forEach items="${Promotions}" var="promo">
                                    <tr class="text-gray-500">
                                        ...
                                        <td class="border-t-0 px-4 align-middle text-xs text-center font-medium text-gray-900 whitespace-nowrap p-4">
                                            <button x-on:click="open = ! open ,idPromo=${promo.getId()}"
                                                    class="mb-2 md:mb-0 w-1/2 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-green-900 hover:text-white">
                                                Valider
                                            </button>
                                            <a href="http://localhost:8080/ResponsableRayon/RefuserPromo?idPromo=${promo.getId()}"
            ...
            <p class="text-center text-sm text-gray-500 my-10">
                &copy; 2021-2022 <a href="#" class="hover:underline" target="_blank">Themesberg</a>. All rights
                reserved.
            </p>
        </div>
    </div>
