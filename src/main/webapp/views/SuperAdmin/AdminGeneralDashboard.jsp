                        ...
                        <div x-show="open==false" class="block w-full overflow-x-auto">
                            ...
                            <table class="items-center w-full bg-transparent border-collapse">
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">
                                        Nom store
                                    </th> <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">
                                        Ville
                                    </th>
                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-center uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px">
                                        statue
